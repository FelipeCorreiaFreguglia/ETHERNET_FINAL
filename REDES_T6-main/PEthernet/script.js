const cableData = [
    ...
    { distance: 100, connector: 'RJ45', standard: '100Base-TX (Fast Ethernet)', type: 'Par trançado (CAT5 ou superior)', maxDistance: '100 m', speed: '100 Mbps' },
    { distance: 100, connector: 'RJ45', standard: '1000Base-T (Gigabit Ethernet)', type: 'Par trançado (CAT5e ou superior)', maxDistance: '100 m', speed: '10 Mbps' },
    { distance: 100, connector: 'RJ45', standard: '10GBase-T', type: 'Par trançado (CAT6e ou superior)', maxDistance: '100 m', speed: '10 Gbps' },
    ...
    { distance: 550, connector: 'SC', standard: '1000Base-SX', type: 'Fibra: Multimodo', maxDistance: '550 m', speed: '1 Gbps' },
    { distance: 550, connector: 'LC', standard: '1000Base-SX', type: 'Fibra: Multimodo', maxDistance: '550 m', speed: '1 Gbps' },
    { distance: 550, connector: 'SC', standard: '1000Base-LX', type: 'Fibra: Multimodo', maxDistance: '550 m', speed: '1 Gbps' },
    { distance: 550, connector: 'LC', standard: '1000Base-LX', type: 'Fibra: Multimodo', maxDistance: '550 m', speed: '1 Gbps' },
    { distance: 2000, connector: 'SC', standard: '100Base-FX', type: 'Fibra: Multimodo', maxDistance: '2 km', speed: '100 Mbps' },
    { distance: 2000, connector: 'LC', standard: '100Base-FX', type: 'Fibra: Multimodo', maxDistance: '2 km', speed: '100 Mbps' },
    { distance: 10000, connector: 'LC', standard: '10GBase-LR', type: 'Fibra:  Monomodo', maxDistance: '10 km', speed: '10 Gbps' },
    { distance: 10000, connector: 'SC', standard: '1000Base-LX', type: 'Fibra:  Monomodo', maxDistance: '10 km', speed: '1 Gbps' },
    ...
    { distance: 10000, connector: 'MPO', standard: '40GBase-LR', type: 'Fibra:  Monomodo', maxDistance: '10 km', speed: '40 Gbps'},
